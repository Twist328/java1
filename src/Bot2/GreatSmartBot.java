...
import ru.progwards.java1.telegrambot.ProgwardsTelegramBot;
    ...
    public class GreatSmartBot extends ProgwardsTelegramBot {
        ...
        public static void main(String[] args) throws NullPointerException {
            ...
            sets = new Sets(bot);
            Food m1 = sets.add("Тянь шань 360р.", "ролл, шань, тянь, снежный краб, краб, огурец, сливочный сыр, угорь, лосось", 1, 360);
            Food m2 = sets.add("Филадельфия Классик 360р.", "ролл, классик, филадельф, сливочный сыр, лосось", 1, 360);
            Food m3 = sets.add("Спайси краб 280р.", "ролл, спайси, снежный краб, краб, икра лосося, спайси соус", 1, 280);
            Food m4 = sets.add("Унаги филадельфия 360р.", "ролл, унаги, филадельф, угорь, сливочный сыр, лосось, соус унаги", 1, 360);
            Food m5 = sets.add("Самурай 320р.", "ролл, самурай, креветка тигр, лосос, томат", 1, 320);
            Food m6 = sets.add("Аляска 270р.", "ролл, аляск, сливочный сыр, креветк, огурец, укроп, икра", 1, 270);
            Food m7 = sets.add("Горячая тортилья 270р.", "ролл, тортил, говя, сливочный сыр, помид, огур, лук", 1, 270);

            Food a1 = sets.add("Больше Имбиря 20р.", "добавк, приправ, имбир", 2, 20);
            a1.linkTo(new Food[]{m1, m2, m4, m5});
            Food a2 = sets.add("Больше Васаби 20р.", "добавк, приправ, васаб", 2, 20);
            a2.linkTo(new Food[]{m2, m3, m4, m5, m6});
            Food a3 = sets.add("Больше Соевого соуса 20р.", "добавк, соус, соев, приправ, васаб", 2, 20);
            a3.linkTo(new Food[]{m5, m6, m7});
