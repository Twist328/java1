...
// , результат - список, содержащий списки строк с именами и полными путями совпадающих файлов.
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(findDuplicates("\\java1\\").toString().replace("], ", "]," + (char) 10));
        System.out.println(findDuplicates("\\Program files\\").toString().replace("], ", "]," + (char) 10));
    ...
    public static <CompareObj, ListObj> List<List<ListObj>> getEquals(List<List<ListObj>> paths, NeedPathValue<CompareObj, ListObj> comp) {
